...
public class PublicTests {
	...
	public void pubTextElementTest1() {
		...
		model.TagElement.enableId(false);
	...
	public void pubHeadingElementTestA() {
		...
		model.TagElement.resetIds();
		model.TagElement.enableId(false);
		model.HeadingElement element = new HeadingElement(new TextElement("Introduction"), level, attributes);
		answer = element.genHTML(indentation);
	...
	public void pubImageElementTest1() {
		...
		model.TagElement.resetIds();
		model.TagElement.enableId(true);
